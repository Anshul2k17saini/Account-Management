  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked" >
        <li class="active"><a href="#profiledetails">Profile_details</a></li>
        <li ><a href="Educationdetails.jsp">Education_details</a></li>
        <li><a href="Bankdetails.jsp">Bank_details</a></li>
      </ul><br>
    </div>
<div class="col-sm-9" >
       <h1>Profile_details</h1>
       <hr>
       <h2>Fill Form To Edit</h2>
<div class="container">
  <form class="form-horizontal" action="Persondata" method="get">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-5">
        ...
        <input type="text" class="form-control"  placeholder="Enter Address" name="Addss" required>
